...
complexConstr :: Constr
complexConstr = mkConstr complexDataType ":+"  [] Infix

complexDataType :: DataType
complexDataType = mkDataType "Data.Complex.Complex" [complexConstr]

instance (Data a, RealFloat a) => Data (Complex a) where
  toConstr _ = complexConstr
  gunfold k z c | constrIndex c == 1 = k (k (z (:+)))
  gunfold _ _ _ = error "gunfold"
  dataTypeOf _  = complexDataType
